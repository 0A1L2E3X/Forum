<template>
  <div>
    <div class="search">
      <el-input placeholder="please enter title" style="width: 200px; margin-right: 10px" v-model="title"></el-input>
      <el-input placeholder="please enter category" style="width: 200px; margin-right: 10px" v-model="categoryName"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="date" label="published date"></el-table-column>
    ...
    <el-dialog title="Information" :visible.sync="fromVisible" width="70%" :close-on-click-modal="false" destroy-on-close>
    ...
    <el-dialog title="content" :visible.sync="fromVisible1" width="50%" :close-on-click-modal="false" destroy-on-close>
      <div class="w-e-text">
