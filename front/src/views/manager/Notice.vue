  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="id" label="sort" width="80" align="center" sortable></el-table-column>
        <el-table-column prop="title" label="title" show-overflow-tooltip></el-table-column>
        <el-table-column prop="content" label="contents" show-overflow-tooltip></el-table-column>
        <el-table-column prop="time" label="published date"></el-table-column>
        <el-table-column prop="user" label="publisher"></el-table-column>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        content: [
          {required: true, message: 'please input contents', trigger: 'blur'},
        ]
      },
      ids: []
    }
